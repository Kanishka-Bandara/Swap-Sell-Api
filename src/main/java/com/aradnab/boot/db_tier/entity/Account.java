...
public class Account {
    ...
    public boolean equals(Object o) {
        ...
        return id == account.id &&
                ...
                Objects.equals(savedAt, account.savedAt) &&
                Objects.equals(lastUpdatedAt, account.lastUpdatedAt) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, userId, savedAt, lastUpdatedAt, deletedAt, status);
    }
    ...
    @OneToMany(mappedBy = "accountByTransactionedBy")
