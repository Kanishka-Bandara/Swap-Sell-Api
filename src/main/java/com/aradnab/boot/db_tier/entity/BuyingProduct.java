...
@Entity
@Table(name = "buying_product", schema = "swap_sell")
public class BuyingProduct {
    ...
    public boolean equals(Object o) {
        ...
        BuyingProduct that = (BuyingProduct) o;
        return id == that.id &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, productId, deliveryProductId, cartItemId, discountId, qty, savedAt, lastUpdatedAt, deletedAt, status);
    }
