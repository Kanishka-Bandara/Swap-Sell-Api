...
@Entity
@Table(name = "user_type", schema = "swap_sell")
public class UserType {
    ...
    public boolean equals(Object o) {
        ...
        return id == userType1.id &&
                ...
                Objects.equals(savedAt, userType1.savedAt) &&
                Objects.equals(lastUpdatedAt, userType1.lastUpdatedAt) &&
                Objects.equals(deletedAt, userType1.deletedAt) &&
                Objects.equals(status, userType1.status);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, userType, savedAt, lastUpdatedAt, deletedAt, status);
    }
